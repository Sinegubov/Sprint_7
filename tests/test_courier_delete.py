...
class TestDeleteCourier:
    ...
    def test_courier_delete(self, generator, url_login=URL.COURIER_LOGIN_URL, url=URL.COURIER_URL):
        data = generator.register_new_courier_and_return_login_password()
    ...
    def test_courier_delete_with_bad_id(self, generator, url=URL.COURIER_URL):
        courier_id = generator.random_string_id()
